      ...
      <div class="card">
        <div class="section-head">
          ...
          <div class="action-with-cost">
            ...
            <span id="generate-product-cost-badge" class="cost-badge" title="سيتم استهلاك 1 نقطة"><span class="cost-dot"></span>1 نقطة</span>
          </div>
        </div>
        <div class="grid" style="margin-top:0;">
          ...
          <div style="grid-column:1/-1;">
            ...
            <p class="muted" style="margin:8px 0 0;">عند التفعيل: يتم تحليل أفضل 10 نتائج لبناء محتوى وميتا أقوى مع الحفاظ على هوية متجرك وتعليمات السيو.</p>
          </div>
        ...
        <div id="generated-result-description-card" class="card surface-soft" style="box-shadow:none;">
          <div class="section-head" style="margin-bottom:10px;">
            ...
            <div style="display:flex;gap:8px;flex-wrap:wrap;">
              <button id="generated-result-description-copy-html-btn" class="btn btn-secondary" type="button" data-copy-mode="html-description">نسخ HTML جاهز</button>
